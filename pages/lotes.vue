...
export default {
  ...
  methods: {
    buscaLotes () {
      ...
      // 'http://74.208.101.117/proyectos/gusher/server/lotes.php?opcion=consulta'
      this.$axios.$get(
        'https://gusher.code-ware.com/lotes.php?opcion=consulta'
      ).then(response => {
...
//      let url = `http://74.208.101.117/proyectos/gusher/server/lotes.php?opcion=rango&etiq1=${this.etiq1}&etiq2=${this.etiq2}`
      this.dialog = true
      this.$axios.$get(
    ...
    dialogFocus () {
      this.dialog = true
      // 'http://74.208.101.117/proyectos/gusher/server/lotes.php?opcion=ultima'
      this.$axios.$get(
        'https://gusher.code-ware.com/lotes.php?opcion=ultima'
      ).then(response => {

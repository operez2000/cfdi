      ...
      <v-list class="my-0 py-0">
        ...
        >
          ...
          <v-list-item
            ...
            @click="drawer = false"
          >
            <v-list-item-title v-text="'Recuperar Factura'"></v-list-item-title>
          </v-list-item>
          <v-list-item
            class="pl-16 pr-6"
            dense
            ...
            @click="drawer = false"
          >
            <v-list-item-title v-text="'Notas de Crédito'"></v-list-item-title>
          </v-list-item>
          <!-- <v-list-item
            class="pl-16 pr-6"
            dense
            ...
            @click="drawer = false"
          >
            <v-list-item-title v-text="'Global'"></v-list-item-title>
          </v-list-item> -->
        </v-list-group>
        <v-list-group
          dense
...
export default {
  ...
  mounted() {
    ...
    this.$vuetify.lang.locales.en.dataTable.itemsPerPageText = 'Registros por Pag'
    this.$vuetify.lang.locales.en.dataFooter.itemsPerPageText = 'Registros por Pag.'
